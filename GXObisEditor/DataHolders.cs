...
//
//
// Filename:        $HeadURL: svn://utopia/projects/GXDeviceEditor/Development/AddIns/DLMS/GXObisEditor/DataHolders.cs $
//
...
namespace GXObisEditor
{
	...
	internal class ObisItem
	{
		...
		public Gurux.DLMS.COBISValueCollection GetValueItems()
		{
			Gurux.DLMS.COBISValueCollection vals = new Gurux.DLMS.COBISValueCollection();
			foreach (Gurux.DeviceEditor.GXValueItem it in ValueItems)
			{
				Gurux.DLMS.COBISValue val = new Gurux.DLMS.COBISValue();
